...
def aspirate(volumes, liquid_class, grid, site, spacing=1, row=1, col=1, labware="greiner96"):
...
def dispense(volumes, liquid_class, grid, site, spacing=1, row=1, col=1, labware="greiner96"):
...
def mix(volumes, liquid_class, grid, site, spacing=1, row=1, col=1, labware="greiner96"):
